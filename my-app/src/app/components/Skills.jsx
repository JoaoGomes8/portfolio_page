  ...
  return (
    <div className="mt-20 text-5xl mx-auto w-fit mb-60 scroll-mt-10" id="experience">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-4 sm:gap-10 md:gap-12 mx-auto w-fit">
        <CardSkills text={"HTML"} image={"/images/html.png"}></CardSkills>
        <CardSkills text={"CSS"} image={"/images/html.png"}></CardSkills>
        ...
        <CardSkills text={"SQL"} image={"/images/sql.png"}></CardSkills>
        ...
        <CardSkills text={"PHP"} image={"/images/node.png"}></CardSkills>
      </div>
    </div>
  );
}
